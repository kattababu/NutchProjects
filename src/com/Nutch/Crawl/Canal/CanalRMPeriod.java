 ...
 *
 */
public class CanalRMPeriod {

	/**
	 * 
	 */
	public CanalRMPeriod() {
	 ...
	 */
		...
		public void QualifierMatchPeriod(String name,String imgs)
		{
			try
			{
	...
	//////////Last _Seen/////////
		...
		public void ImageUrlsPeriod(String name)
		{
							...
							//System.out.println(content);
							 ...
							 Element el=document.body();
							  ...
							  for(Element el1:els)
							  {
								  ...
								  QualifierMatchPeriod(attrh,imgs);
